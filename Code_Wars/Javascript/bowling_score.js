// Description: http://www.codewars.com/kata/5427db696f30afd74b0006a3
//
// Task
//
...
var bowlingScore = function(rolls) {
  var frames = [];
  for(var i=0; i<10; i++){
    rolls[0] == 10 ? frames.push( rolls.shift()+rolls[0]+rolls[1] ) :
      rolls[0]+rolls[1] == 10 ? frames.push(rolls.shift()+rolls.shift()+rolls[0]) :
        frames.push(rolls.shift() + rolls.shift());
  }
  return frames.reduce((p,c) => p+c);
}
