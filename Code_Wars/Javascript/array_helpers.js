// Description: http://www.codewars.com/kata/525d50d2037b7acd6e000534
//
...
Array.prototype.square = function(){
  return this.map((cv, i, a) => Math.pow(cv,2));
}

Array.prototype.cube = function(){
  return this.map((cv, i, a) => Math.pow(cv,3));
}
...
Array.prototype.even = function(){
  return this.filter( function(val){ return val % 2 === 0; });
}
